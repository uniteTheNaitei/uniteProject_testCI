...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<body>
		...
		<div class="fh5co-parallax" style="background-image: url(/assets/images/home-image-3.jpg);" data-stellar-background-ratio="0.5">
		...
		<div id="fh5co-team-section" class="fh5co-lightgray-section">
			<div class="container">
				...
				<div class="row text-center">
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(/assets/images/trainer-1.jpg);">
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(/assets/images/trainer-2.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>James Smith</h3>
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(/assets/images/trainer-3.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>John Doe</h3>
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(/assets/images/trainer-4.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>John Doe</h3>
									<span>Chief Executive Officer</span>
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(/assets/images/trainer-5.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>John Doe</h3>
									<span>Chief Executive Officer</span>
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(/assets/images/trainer-6.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>John Doe</h3>
									<span>Chief Executive Officer</span>
		...
		<div class="fh5co-parallax" style="background-image: url(/assets/images/home-image-2.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
						...
						<div class="col-md-12 col-md-offset-0">
							<div class="fh5co-blog animate-box">
								<div class="inner-post">
									<a href="#"><img class="img-responsive" src="{{Asset('assets/images/blog-1.jpg')}}" alt=""></a>
								</div>
								<div class="desc">
